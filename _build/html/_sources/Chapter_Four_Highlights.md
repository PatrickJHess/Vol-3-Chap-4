# Bootstrapping The Term Structure With A Few Hundred Bonds
...
* **Python concepts:**  
  ...
  * Pandas DataFrames  
    ...
    * method <font color='green'>apply</font>  
  * Custom modules.  
...
2. The  Jupyter notebook *Using the linalg module of NumPy* illustrates the calculations of  *Inferring zero prices from the present value function*  with the **linalg** module.  
